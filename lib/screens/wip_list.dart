...
//       filteredWip = filteredWip
//           .where(
//             (wip) =>
//                 SearchUtils.matchesSearchWip(wip, _searchQuery) ||
//                 wip.wipCode.toLowerCase().contains(
//                   _searchQuery.toLowerCase(),
//                 ) ||
//                 wip.projectName.toLowerCase().contains(
//                   _searchQuery.toLowerCase(),
//                 ),
//           )
//           .toList();
...
class _WIPListScreenState extends State<WIPListScreen> {
  ...
  void _fetchData() async {
    try {
      ...
      _applyDateFilter(); // Apply initial filter after loading data
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to load data: ${e.toString()}')),
      );
